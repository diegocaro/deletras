...
<div id="sidebar">
    ...
    <h1 class="first">Albums with <?php e($track['Track']['name']); ?></h1>
...
<div id="menutrack">            
               <div class="actions-edit">
                ...
                <div class="addthis">
                    ...
                    <a href="http://www.addthis.com/bookmark.php?v=20" onmouseover="return addthis_open(this, '', '[URL]', '[TITLE]')" onmouseout="addthis_close()" onclick="return addthis_sendto()">
                        <img src="http://s7.addthis.com/static/btn/lg-share-en.gif" width="125" height="16" alt="Bookmark and Share" style="border:0" align="top"/>
                    </a>
	    ...
	    */ ?>            
            <div id="infotrack">
                ...
                <h2>by <?php e($link->makeArtist($track['Artist']['name']));?></h2>
                <div class="addthis">
                    <!-- AddThis Button BEGIN -->
                    <script type="text/javascript">
                        var addthis_pub="diegocaro";
	    ...
	    */ ?>
        ...
        <div class="right">
            ...
            <h3>Listen <?php echo $track['Track']['name']; ?> (<?php echo $link->makeArtist($track['Artist']['name']); ?>)
            ...
            <h3>Watch the video of <?php echo $track['Track']['name']; ?> (<?php echo $link->makeArtist($track['Artist']['name']); ?>)
            ...
            ?>
            <h2>Albums with <?php e($track['Track']['name']); ?></h2>
            <div id="minilistalbum">
